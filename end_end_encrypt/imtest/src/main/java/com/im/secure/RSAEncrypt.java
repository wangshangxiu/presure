...
public class RSAEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RSAPublicKey pubkey=loadPublicKeyByStr(loadPublicKeyByFile("c:\\dev\\test"));

        String input="123456789";
        byte[] buf=encrypt(pubkey,input.getBytes());
       String out = new String(Base64.encodeBase64(buf));
...
//解密
        ...
        RSAPrivateKey prikey =loadPrivateKeyByStr( prikeystr);
        String decryptstr= new String(decrypt(prikey,buf));
        System.out.println("encrypt:"+decryptstr);
