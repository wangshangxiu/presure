...
class PreKeySignalMessageToServer implements CiphertextMessage {
...
//解析成 各个成员的报
  public PreKeySignalMessageToServer(byte[] serialized, ConcurrentHashMap<Long,  UserKey> userHashMap)
...
/*
  ...
  public PreKeySignalMessageToServer(int messageVersion, int registrationId, int preKeyId,
