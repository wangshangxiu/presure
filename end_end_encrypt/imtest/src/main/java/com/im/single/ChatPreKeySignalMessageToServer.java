...
class ChatPreKeySignalMessageToServer implements CiphertextMessage {
...
//解析成 各个成员的报
  public ChatPreKeySignalMessageToServer(byte[] serialized, ConcurrentHashMap<Long,  UserKey> userHashMap)
...
/*
  ...
  public ChatPreKeySignalMessageToServer(int messageVersion, int registrationId, int preKeyId,
