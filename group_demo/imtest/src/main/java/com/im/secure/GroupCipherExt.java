...
public class GroupCipherExt   {
    ...
    public GroupCipherExt(SenderKeyStore senderKeyStore, SenderKeyName senderKeyId) {
    ...
    {
        return decrypt(senderKeyMessageBytes, new GroupCipherExt.NullDecryptionCallback());
    }
