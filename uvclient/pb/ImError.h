...
enum E_ERROR_NO
{
	...
	ERR_MONGODB_CONNECT       				 = 20050,    ///< mongodb连接错误
	ERR_MONGODB_SEARCH       				 = 20051,    ///< mongodb查询失败

	ERR_ROCKETMQ_CONNECT       				 = 20060,    ///< mongodb连接错误
	ERR_ROCKETMQ_SEARCH       				 = 20061,    ///< mongodb查询失败


	ERR_GATE_TRANSFER                        = 20070,    ///< 网关推送失败
	...
	ERR_PROTOCAL_ERROR			     		 = 20223,    ///< 协议错误
    ERR_GENERATE_ECHDKEY_ERROR               = 20224,    ///< 生成最终对称加密key错误
    ERR_RSADATA_TOOLONG_ERROR                = 20225,    ///< rsa解密数据过长
	...
	ERR_LOGIN_REPEATED                  	  = 21030 ,//用户重复登录
    ERR_LOGINSEQ_ERROR                        = 21031 ,//用户登录SEQ值错误

    ///<22000~22999	用户关系命令字，如关注、取消关注、添加好友、删除好友、拉黑、举报等	用户关系
    ERR_FRIEND_RELATION_UNKONW               = 22001 ,//好友关系保留
    ERR_USER_RELIEVE_FRIEND                  = 22002 ,//你解除了好友
    ERR_USER_BLACK_FRIEND                    = 22003 ,//你拉黑了好友
    ERR_FRIEND_RELIEVE_USER                  = 22004 ,//好友解除了你
    ERR_FRIEND_BLACK_USER                    = 22005 ,//好友拉黑你
